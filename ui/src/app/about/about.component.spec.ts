...
describe('AboutComponent', () => {
  ...
  it('About displays base server and link information.', () => {
    ...
    expect(des[1].nativeElement.textContent).toContain('https://cloud.spring.io/spring-cloud-dataflow/');
    ...
    expect(des[5].nativeElement.textContent).toContain('https://docs.spring.io/spring-cloud-dataflow/docs/BOO/reference/htmlsingle/');
    expect(des[6].nativeElement.textContent).toContain('API Docs');
    expect(des[7].nativeElement.textContent).toContain('https://docs.spring.io/spring-cloud-dataflow/docs/BOO/api/');
    expect(des[8].nativeElement.textContent).toContain('Support Forum');
    expect(des[9].nativeElement.textContent).toContain('https://stackoverflow.com/questions/tagged/spring-cloud-dataflow');
